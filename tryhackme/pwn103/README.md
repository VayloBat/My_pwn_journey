...
More importantly, I found a hidden function called `admin_house` (or similar) at address `0x401554` that basically just hands us a shell. Our job? Redirect execution there.
